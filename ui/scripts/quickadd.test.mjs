...
check(
  'an unknown flag stays in the title',
  line('Careful! this is !urgnt').title,
  'Careful! this is !urgnt',
)
...
check(
  'nor one inside an address',
  line('Reply to ana@example.com').title,
...
check(
  'today and tomorrow',
  [parseDueDate('today', TODAY), parseDueDate('tmr', TODAY)],
  [TODAY, '2026-09-07'],
)
