...
<div class="wrap">
  <div class="card">
    ...
    <p class="reassure">
      Your journal has not been changed. Nothing was written, and nothing was deleted — this is a
      problem reaching the storage backend, not a problem with your entries.
    </p>
