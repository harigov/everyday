...
export const ICONS = {
  ...
  // The quiet counterpart to `alert`, on the same 8.5-radius circle as
  // `check` and `clock` so a stack of notifications lines up.
  info: '<circle cx="12" cy="12" r="8.5"/><path d="M12 11.5V16"/><path d="M12 8h.01"/>',
