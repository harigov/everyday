...
.DEFAULT_GOAL := help
.PHONY: help setup run dev ui build test test-postgres test-imap test-smtp test-mail lint check fix fmt cli icons desktop-entry undesktop-entry clean distclean
